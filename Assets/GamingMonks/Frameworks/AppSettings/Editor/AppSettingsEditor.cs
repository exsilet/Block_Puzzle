	...
	public class AppSettingsEditor : CustomInspectorHelper 
	{
        ...
        void DrawDailyRewardsSetup() 
		{
			...
			if(allDayRewards.arraySize > 0) {
				...
				for(int i = 0; i < allDayRewards.arraySize; i++) 
				{
					...
					if(isOpened) {
						EditorGUILayout.BeginHorizontal();
						EditorGUILayout.LabelField("Coin Amount : ", GUILayout.MaxWidth(200));
						//allDayRewards.GetArrayElementAtIndex(i).intValue = EditorGUILayout.IntField(allDayRewards.GetArrayElementAtIndex(i).intValue);
						appSettings.dailyRewardsSettings.allDayRewards[i].allCoinRewards = EditorGUILayout.IntField(appSettings.dailyRewardsSettings.allDayRewards[i].allCoinRewards);
						EditorGUILayout.EndHorizontal();

                        EditorGUILayout.Space(3);

                        EditorGUILayout.BeginHorizontal();
                        EditorGUILayout.LabelField("Life Amount : ", GUILayout.MaxWidth(200));
                        //allDayRewards.GetArrayElementAtIndex(i).intValue = EditorGUILayout.IntField(allDayRewards.GetArrayElementAtIndex(i).intValue);
                        appSettings.dailyRewardsSettings.allDayRewards[i].allLifeRewards = EditorGUILayout.IntField(appSettings.dailyRewardsSettings.allDayRewards[i].allLifeRewards);
                        EditorGUILayout.EndHorizontal();

                        EditorGUILayout.Space(3);

                        EditorGUILayout.BeginHorizontal();
                        EditorGUILayout.LabelField("Rotate Amount : ", GUILayout.MaxWidth(200));
                        //allDayRewards.GetArrayElementAtIndex(i).intValue = EditorGUILayout.IntField(allDayRewards.GetArrayElementAtIndex(i).intValue);
                        appSettings.dailyRewardsSettings.allDayRewards[i].allRotateRewards = EditorGUILayout.IntField(appSettings.dailyRewardsSettings.allDayRewards[i].allRotateRewards);
                        EditorGUILayout.EndHorizontal();

                        EditorGUILayout.Space(3);

                        EditorGUILayout.BeginHorizontal();
                        EditorGUILayout.LabelField("Single Block Amount : ", GUILayout.MaxWidth(200));
                        //allDayRewards.GetArrayElementAtIndex(i).intValue = EditorGUILayout.IntField(allDayRewards.GetArrayElementAtIndex(i).intValue);
                        appSettings.dailyRewardsSettings.allDayRewards[i].allSingleBlockRewards = EditorGUILayout.IntField(appSettings.dailyRewardsSettings.allDayRewards[i].allSingleBlockRewards);
                        EditorGUILayout.EndHorizontal();

                        EditorGUILayout.Space(3);

                        EditorGUILayout.BeginHorizontal();
                        EditorGUILayout.LabelField("Bomb Amount : ", GUILayout.MaxWidth(200));
                        //allDayRewards.GetArrayElementAtIndex(i).intValue = EditorGUILayout.IntField(allDayRewards.GetArrayElementAtIndex(i).intValue);
                        appSettings.dailyRewardsSettings.allDayRewards[i].allBombRewards = EditorGUILayout.IntField(appSettings.dailyRewardsSettings.allDayRewards[i].allBombRewards);
                        EditorGUILayout.EndHorizontal();
                    }
					EndBox();
				}
			...
			EditorGUILayout.HelpBox("All rewards are given in COINS currency.",MessageType.Info);
		...
		void DrawMiscSettings() 
		{
			...
			if(isExpanded) 
			{
				...
				GUILayout.Space(2);
				EditorGUILayout.BeginHorizontal();
				EditorGUILayout.LabelField("Initial Coins Amount : ",  labelStyle,GUILayout.MaxWidth(300));
				appSettings.defaultCoinAmount = EditorGUILayout.IntField(appSettings.defaultCoinAmount);
				EditorGUILayout.EndHorizontal();
				
				GUILayout.Space(2);
				EditorGUILayout.BeginHorizontal();
				EditorGUILayout.LabelField("Watch Ads Reward (COINS) : ",  labelStyle,GUILayout.MaxWidth(300));
				appSettings.watchAdsRewardCoin = EditorGUILayout.IntField(appSettings.watchAdsRewardCoin);
				EditorGUILayout.EndHorizontal();

				GUILayout.Space(2);
				EditorGUILayout.BeginHorizontal();
                EditorGUILayout.LabelField("Watch Ads Reward (Life) : ", GUILayout.MaxWidth(300));
                appSettings.watchAdsRewardLife = EditorGUILayout.IntField(appSettings.watchAdsRewardLife);
                EditorGUILayout.EndHorizontal();
                
                GUILayout.Space(2);
                EditorGUILayout.BeginHorizontal();
                EditorGUILayout.LabelField("Watch Ads Reward (Moves) : ", GUILayout.MaxWidth(300));
                appSettings.watchAdsRewardMoves = EditorGUILayout.IntField(appSettings.watchAdsRewardMoves);
                EditorGUILayout.EndHorizontal();
                
                GUILayout.Space(2);
                EditorGUILayout.BeginHorizontal();
                EditorGUILayout.LabelField("Watch Ads Reward (Time) : ", GUILayout.MaxWidth(300));
                appSettings.watchAdsRewardTime = EditorGUILayout.FloatField(appSettings.watchAdsRewardTime);
                EditorGUILayout.EndHorizontal();
                
                GUILayout.Space(2);
                EditorGUILayout.BeginHorizontal();
                EditorGUILayout.LabelField("Rescue Cost (COINS) : ",  labelStyle,GUILayout.MaxWidth(300));
                appSettings.rescueGameCoinsCost = EditorGUILayout.IntField(appSettings.rescueGameCoinsCost);
                EditorGUILayout.EndHorizontal();
                
                GUILayout.Space(2);
                EditorGUILayout.BeginHorizontal();
                EditorGUILayout.LabelField("Life Cost (COINS) : ", GUILayout.MaxWidth(300));
                appSettings.lifeCost = EditorGUILayout.IntField(appSettings.lifeCost);
                EditorGUILayout.EndHorizontal();
                
                GUILayout.Space(2);
                EditorGUILayout.BeginHorizontal();
                EditorGUILayout.LabelField("Rotate PowerUp Cost : ", GUILayout.MaxWidth(300));
                appSettings.rotatePowerUpCost = EditorGUILayout.IntField(appSettings.rotatePowerUpCost);
                EditorGUILayout.EndHorizontal();

                GUILayout.Space(2);
                EditorGUILayout.BeginHorizontal();
                EditorGUILayout.LabelField("Single Block PowerUp Cost : ", GUILayout.MaxWidth(300));
                appSettings.singleBlockPowerUpCost = EditorGUILayout.IntField(appSettings.singleBlockPowerUpCost);
                EditorGUILayout.EndHorizontal();

                GUILayout.Space(2);
                EditorGUILayout.BeginHorizontal();
                EditorGUILayout.LabelField("Bomb PowerUp Cost : ", GUILayout.MaxWidth(300));
                appSettings.bombPowerUpCost = EditorGUILayout.IntField(appSettings.bombPowerUpCost);
                EditorGUILayout.EndHorizontal();
