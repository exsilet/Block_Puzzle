...
namespace GamingMonks
{
    ...
    public class UIThemeSettingsEditor : CustomInspectorHelper
    {
                    ...
                    for (int i = 0; i < list.arraySize; i++)
                    {
                        ...
                        if (isOpened)
                        {
                            ...
                            if (isEnabled.boolValue)
                            {
                                ...
                                EditorGUILayout.BeginHorizontal();
                                EditorGUILayout.LabelField("Theme IAP ID", labelStyle, GUILayout.MaxWidth(100));
                                EditorGUILayout.LabelField("", labelStyle, GUILayout.MinWidth(0));
                                SerializedProperty themeIAPId = list.GetArrayElementAtIndex(i).FindPropertyRelative("themeIAPID");
                                uiThemeSettings.allThemeConfigs[i].themeIAPID = (IAPProductID)EditorGUILayout.EnumPopup(uiThemeSettings.allThemeConfigs[i].themeIAPID);
                                EditorGUILayout.EndHorizontal();
                                ...
                                if(defaultStatus.intValue == 0) {
                                    ...
                                    EditorGUILayout.BeginHorizontal();
                                    EditorGUILayout.LabelField("Unlock Cost (COINS) : ", labelStyle, GUILayout.MaxWidth(150));
                                    EditorGUILayout.LabelField("", labelStyle, GUILayout.MinWidth(0));
        ...
        void CreateNewTheme()
        {
            string assetPath = "Assets/GamingMonks/Resources/UIThemes";
            string folderPath = Application.dataPath + "/" + "GamingMonks/Resources/UIThemes";
