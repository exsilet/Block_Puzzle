...
{    
    ...
    public class SpriteAlpha : MonoBehaviour
    {
        ...
        public SpriteAlpha SetDelay(float _delay) {
            delay = _delay;
            return this;
        } 

        // Set given ease type for the tween.
        public SpriteAlpha SetEase(Ease ease) {
            easeType = ease;
            return this;
        }

        // Set given loop type for the tween.
        public SpriteAlpha SetLoop(int _loopCount, LoopType _loopType = LoopType.PingPong) {
        ...
        public SpriteAlpha SetAnimation(AnimationCurve curve) {
        ...
        public SpriteAlpha OnComplete(Action onComplete){
            OnCompleteDeletegate = onComplete;
            return this;
        }

        // Invokes Tween loop complete event callback.
        public SpriteAlpha OnLoopComplete(Action<int> onLoopComplete){
