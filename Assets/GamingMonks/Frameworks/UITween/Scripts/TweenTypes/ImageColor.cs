...
{    
    public class ImageColor : MonoBehaviour
    {
        ...
        public ImageColor SetDelay(float _delay) {
            delay = _delay;
            return this;
        } 

        // Set given ease type for the tween.
        public ImageColor SetEase(Ease ease) {
            easeType = ease;
            return this;
        }

        // Set given loop type for the tween.
        public ImageColor SetLoop(int _loopCount, LoopType _loopType = LoopType.PingPong) {
        ...
        public ImageColor SetAnimation(AnimationCurve curve) {
        ...
        public ImageColor OnComplete(Action onComplete){
            OnCompleteDeletegate = onComplete;
            return this;
        }

        // Invokes Tween loop complete event callback.
        public ImageColor OnLoopComplete(Action<int> onLoopComplete){
