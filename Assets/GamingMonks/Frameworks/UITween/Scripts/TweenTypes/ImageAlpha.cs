...
{    
    ...
    public class ImageAlpha : MonoBehaviour
    {
        ...
        public ImageAlpha SetDelay(float _delay) {
            delay = _delay;
            return this;
        } 
        
        // Set given ease type for the tween.
        public ImageAlpha SetEase(Ease ease) {
            easeType = ease;
            return this;
        }

        // Set given loop type for the tween.
        public ImageAlpha SetLoop(int _loopCount, LoopType _loopType = LoopType.PingPong) {
        ...
        public ImageAlpha SetAnimation(AnimationCurve curve) {
        ...
        public ImageAlpha OnComplete(Action onComplete){
            OnCompleteDeletegate = onComplete;
            return this;
        }

        // Invokes Tween loop complete event callback.
        public ImageAlpha OnLoopComplete(Action<int> onLoopComplete){
