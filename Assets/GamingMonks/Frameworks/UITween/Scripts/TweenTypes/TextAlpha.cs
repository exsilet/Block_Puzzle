...
{    
    ...
    public class TextAlpha : MonoBehaviour
    {
        ...
        public TextAlpha SetDelay(float _delay) {
            delay = _delay;
            return this;
        } 

        // Set given ease type for the tween.
        public TextAlpha SetEase(Ease ease) {
            easeType = ease;
            return this;
        }

        // Set given loop type for the tween.
        public TextAlpha SetLoop(int _loopCount, LoopType _loopType = LoopType.PingPong) {
        ...
        public TextAlpha SetAnimation(AnimationCurve curve) {
        ...
        public TextAlpha OnComplete(Action onComplete){
            OnCompleteDeletegate = onComplete;
            return this;
        }

        // Invokes Tween loop complete event callback.
        public TextAlpha OnLoopComplete(Action<int> onLoopComplete){
