...
{    
    ...
    public class SpriteColor : MonoBehaviour
    {
        ...
        public SpriteColor SetDelay(float _delay) {
            delay = _delay;
            return this;
        }   

        // Set given ease type for the tween.
        public SpriteColor SetEase(Ease ease) {
            easeType = ease;
            return this;
        }

        // Set given loop type for the tween.
        public SpriteColor SetLoop(int _loopCount, LoopType _loopType = LoopType.PingPong) {
        ...
        public SpriteColor SetAnimation(AnimationCurve curve) {
        ...
        public SpriteColor OnComplete(Action onComplete){
            OnCompleteDeletegate = onComplete;
            return this;
        }

        // Invokes Tween loop complete event callback.
        public SpriteColor OnLoopComplete(Action<int> onLoopComplete){
