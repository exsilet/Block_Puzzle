...
namespace GamingMonks.UITween
{
    ...
    public class CanvasGroupAlpha : MonoBehaviour
    {
        ...
        public CanvasGroupAlpha SetDelay(float _delay)
        {
            delay = _delay;
            return this;
        }
        ...
        public CanvasGroupAlpha SetEase(Ease ease)
        {
            easeType = ease;
            return this;
        }
        ...
        public CanvasGroupAlpha SetLoop(int _loopCount, LoopType _loopType = LoopType.PingPong)
        {
        ...
        public CanvasGroupAlpha SetAnimation(AnimationCurve curve)
        {
        ...
        public CanvasGroupAlpha OnComplete(Action onComplete)
        {
        ...
        public CanvasGroupAlpha OnLoopComplete(Action<int> onLoopComplete)
        {
