...
{    
    ...
    public class ImageFillAmount : MonoBehaviour
    {
        ...
        public ImageFillAmount SetDelay(float _delay) {
            delay = _delay;
            return this;
        } 

        // Set given ease type for the tween.
        public ImageFillAmount SetEase(Ease ease) {
            easeType = ease;
            return this;
        }

        // Set given loop type for the tween.
        public ImageFillAmount SetLoop(int _loopCount, LoopType _loopType = LoopType.PingPong) {
        ...
        public ImageFillAmount SetAnimation(AnimationCurve curve) {
        ...
        public ImageFillAmount OnComplete(Action onComplete){
            OnCompleteDeletegate = onComplete;
            return this;
        }

        // Invokes Tween loop complete event callback.
        public ImageFillAmount OnLoopComplete(Action<int> onLoopComplete){
