...
{    
    ...
    public class TextColor : MonoBehaviour
    {
        ...
        public TextColor SetDelay(float _delay) {
            delay = _delay;
            return this;
        } 

        // Set given ease type for the tween.
        public TextColor SetEase(Ease ease) {
            easeType = ease;
            return this;
        }
        // Set given loop type for the tween.
        public TextColor SetLoop(int _loopCount, LoopType _loopType = LoopType.PingPong) {
        ...
        public TextColor SetAnimation(AnimationCurve curve) {
        ...
        public TextColor OnComplete(Action onComplete){
            OnCompleteDeletegate = onComplete;
            return this;
        }

        // Invokes Tween loop complete event callback.
        public TextColor OnLoopComplete(Action<int> onLoopComplete){
