...
namespace GamingMonks.Tutorial
{
    public class GamePlay : Singleton<GamePlay>
    {
        ...
        //checks if TutorialStepCompleted function is called once for each step.
        ...
        /// <summary>
        /// Clears given row from the grid.
        /// </summary>
        ...
        /// <summary>
        /// Clears given column from the grid.
        /// </summary>
        public void ClearColumn(int columnId)
        {
