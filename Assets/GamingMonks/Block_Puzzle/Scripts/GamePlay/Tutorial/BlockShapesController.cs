...
namespace GamingMonks.Tutorial
{
    ...
    public class BlockShapesController : MonoBehaviour
    {
        ...
        public List<BlockShape> tutorialBlockShapes_3 = new List<BlockShape>();
        ...
        void PrepareShapePool()
        {
            ...
            if(currentTutorialStep == 2) 
            {
                ...
                // Gets all the standard shapes added in gameplay settings.
                foreach(BlockShape blockShape in tutorialBlockShapes_2) {
                    blockShapesPool.Add(blockShape.gameObject);
                }
                Invoke("ShowDragTip", 1F);
            }
            if (currentTutorialStep == 3)
            {
                ...
                // Gets all the standard shapes added in gameplay settings.
                foreach (BlockShape blockShape in tutorialBlockShapes_3)
                {
                    blockShapesPool.Add(blockShape.gameObject);
                }
                Invoke("ShowDragTip", 1F);
        ...
        public Transform GetMiddleContainerTransform()
        {
            return allShapeContainers[(int)allShapeContainers.Count / 2].transform;
        }
    }
}