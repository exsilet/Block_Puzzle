...
public class GamePlaySettings : ScriptableObject
{
    ...
    // List of block sprite color tags.
    public string[] blockSpriteColorTags;

    //Global block size and space values for level mode
    public float globalLevelModeBlockSize;
    public float globalLevelModeBlockSpace;
    
    // Offset from finger while dragging block shape for level mode that will be reflected in all levels.
    public float globalLevelShapeDragPositionOffset = 1.0F;
    
    [Tooltip("The value that will be added/subtracted in Level's max moves.")]
    public int globalLevelModeMaxMovesOffset;

    //list of prefabs and probabilities for levels.
    public BlockShapeLevelInfo[] blockShapeLevelInfo;

    public int[] levelToLoadInfo;
    #endregion
...
[System.Serializable]
public class BlockShapeLevelInfo
{
    public int minLevel;
    public int maxLevel;
    public BlockShapeLevelListInfo[] blockShapeInfoList;
}

[System.Serializable]
public class BlockShapeLevelListInfo
{
...
public class GameModeSettings
{
    ...
    // Maximum moves allowed in a level.
    public int maxMoves;
    ...
    // Should pick shapes color from this level or not.
    public bool pickShapeColorsFromThisLevel = false;

    //should spawn shape from this level or not
    public bool pickShapeFromThisLevel = false;
...
[System.Serializable] 
public struct BlockShapeProbabilityInfo
{
    public GameObject blockShape;
    public float spawnProbality;
